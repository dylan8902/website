...
Rails.application.configure do
  ...
  config.hosts << "dev.alice-jones.co.uk"
  config.hosts << "dev.alice.cymru"
  config.hosts << "dev.isitaproxyproblem.com"
  ...
  config.hosts << "dev.westsidestory2013.dyl.anjon.es"
  config.hosts << "dev.westsidestory.dyl.anjon.es"
  config.hosts << "dev.ismytraindelayed.com"
  config.hosts << "dev.ismybusdelayed.com"
