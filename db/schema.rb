...
ActiveRecord::Schema.define(version: 20170213220910) do
  ...
  create_table "tweets", id: :bigint, default: nil, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "text"
    t.string   "location"
    t.float    "lat",        limit: 24
    t.float    "lng",        limit: 24
